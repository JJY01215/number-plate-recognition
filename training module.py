...
train_datagen = ImageDataGenerator(
    ...
    width_shift_range=0.3,  # 增加水平移動範圍
    height_shift_range=0.3,  # 增加垂直移動範圍
    shear_range=0.2,  # 加入錯切變換
    zoom_range=0.2,  # 加入縮放變換
    horizontal_flip=True,
    fill_mode='nearest',
    brightness_range=[0.8, 1.2]  # 調整亮度範圍
)
...
# 編譯模型（較小學習率）
model.compile(optimizer=Adam(learning_rate=1e-5),  # 調整學習率
